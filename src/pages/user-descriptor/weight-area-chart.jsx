...
export class WeightAreaChart extends React.Component {
  render() {
    return (
      <ReactEcharts
          ...
          xAxis: [
            {
              ...
              type: "category",
              boundaryGap: false,
              data: processDataList(arrData).ranges.slice(1)
            }
          ],
          ...
          series: [
            {
              ...
              stack: "total",
              areaStyle: {},
              data: processDataList(arrData).maleweight.slice(1)
            },
            {
              name: "Female",
              type: "line",
              ...
              areaStyle: { normal: {} },
              data: processDataList(arrData).femaleweight.slice(1)
            }
          ]
        }}
      />
